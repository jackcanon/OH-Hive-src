// The Honey currency symbol (docs/honey-logo-package/masters/svg/honey-symbol-gold.svg), same path as apps/web.
export function HoneyMark({ height = "1em", title = "Honey" }: { height?: string | number; title?: string }) {
  return (
    <svg viewBox="0 0 600 656" role="img" aria-label={title} style={{ height, width: "auto", verticalAlign: "-0.1em" }} xmlns="http://www.w3.org/2000/svg">
